...
*
* Date: ${timestamp}
* Modified for Microchip Tech Inc. by Purush Kothandapani
*/
(function($) {
        ...
        if (_supported) {
            ...
            $(this).each(function() {
                ...
                var table = this.tagName.toLowerCase() == 'table' ? $(this) : $('table', this),
                    ...
                    parent = table.parent(),
                    thead = $('thead > tr:first-child', table);
                ...
                if (thead.length) {
                    ...
                    _tables.push($('<table />').attr(CLAZZ, clazz)
                            ...
                            .css({ position: $.support.boxModel ? 'fixed' : 'absolute', top: 0 }).appendTo($('<' + parent.get(0).tagName + '/>')
